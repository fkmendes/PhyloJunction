...
class AnnotatedTree(dp.Tree):
    ...
    def __init__(self, a_tree: dp.Tree, total_state_count: int, start_at_origin: bool = ..., max_age: ty.Optional[float] = ..., slice_t_ends: ty.List[ty.Optional[float]] = ..., slice_age_ends: ty.Optional[ty.List[float]] = ..., tree_died: ty.Optional[bool] = None, epsilon: float = ...) -> None: ...
