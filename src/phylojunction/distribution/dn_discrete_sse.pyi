...
class DnSSE(pgm.DistributionPGM):
    ...
    def execute_birth(self, tr_namespace: dp.TaxonNamespace, chosen_node: dp.Node, state_representation_dict: ty.Dict[int, ty.Set[str]], untargetable_node_set, cumulative_node_count: int, macroevol_atomic_param: sseobj.AtomicSSERateParameter, debug: bool = ...) -> ty.Tuple[dp.Node, int]: ...
    ...
    def execute_sample_ancestor(self, tr_namespace: dp.TaxonNamespace, chosen_node: dp.Node, state_representation_dict: ty.Dict[int, ty.Set[str]], untargetable_node_set, cumulative_sa_count: int, debug: bool = ...) -> int: ...
    def execute_event(self, tr_namespace, macroevol_rate_param: sseobj.AtomicSSERateParameter, chosen_node: dp.Node, state_representation_dict: ty.Dict[int, ty.Set[str]], untargetable_node_set, cumulative_node_count: int, cumulative_sa_count: int, last_chosen_node, debug: bool = ...) -> ty.Tuple[dp.Node, int, int]: ...
