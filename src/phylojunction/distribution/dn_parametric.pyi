...
class DnLogNormal(pgm.DistributionPGM):
    ...
    def __init__(self, n_draws: int, n_repl: int, ln_mean_param: ty.List[float], ln_sd_param: ty.List[float], ln_log_space: bool, parent_node_tracker: ty.Optional[ty.Dict[str, str]] = ...) -> None: ...
...
class DnNormal(pgm.DistributionPGM):
    ...
    def __init__(self, n_draws: int, n_repl: int, norm_mean_param: ty.List[float], sd_param: ty.List[float], parent_node_tracker: ty.Optional[ty.Dict[str, str]] = ...) -> None: ...
    def generate(self) -> ty.List[float]: ...
    def _check_sample_size(self, param_list: ty.Optional[ty.List[ty.Any]]=None) -> ty.Optional[ty.List[ty.List[ty.Union[int, float, str]]]]: ...
    def get_rev_inference_spec_info(self) -> ty.List[str]: ...
...
class DnExponential(pgm.DistributionPGM):
    ...
    def __init__(self, n_draws: int, n_repl: int, rate_param: ty.List[float], rate_parameterization: bool, parent_node_tracker: ty.Optional[ty.Dict[str, str]] = ...) -> None: ...
    def generate(self) -> ty.List[float]: ...
    def _check_sample_size(self, param_list: ty.Optional[ty.List[ty.Any]]=None) -> ty.Optional[ty.List[ty.List[ty.Union[int, float, str]]]]: ...
    def get_rev_inference_spec_info(self) -> ty.List[str]: ...
