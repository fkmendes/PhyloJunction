...
class DnSSE(pgm.DistributionPGM):
    ...
    def execute_anatrans(self, chosen_node: dp.Node, state_representation_dict: ty.Dict[int, ty.Set[str]], macroevol_rate_param: sseobj.AtomicSSERateParameter, debug: bool=False) -> None:
