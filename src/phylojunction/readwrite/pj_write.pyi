...
def prep_data_df(sample_size: int, node_pgm_list: ty.List[pgm.NodePGM]) -> ty.Tuple[ty.List[ty.Union[pd.DataFrame, ty.Dict[int, pd.DataFrame]]], ty.List[ty.Union[ty.Dict[str, pd.DataFrame], ty.Dict[str, str]]]]: ...
