...
def prep_data_df(sample_size: int, node_pgm_list: ty.List[pgm.NodePGM], write_nex_states: bool=False) -> ty.Tuple[ty.List[ty.Union[pd.DataFrame, ty.Dict[int, pd.DataFrame]]], ty.List[ty.Union[ty.Dict[str, pd.DataFrame], ty.Dict[str, str]]]]: ...
...
def dump_pgm_data(dir_string: str, pgm_obj: pgm.ProbabilisticGraphicalModel, prefix: str, write_nex_states: bool = ...) -> None: ...
