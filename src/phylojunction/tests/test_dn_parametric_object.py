...
if __name__ == '__main__':
    ...
    # $ python3 test_dn_parametric_object.py
    # 
    # can also be called from phylojunction/
    # $ python3 tests/test_dn_parametric_object.py
    # or
    # $ python3 -m tests.test_dn_parametric_object
    # or, for a specific test
    # $ python3 -m unittest tests.test_dn_parametric_object.TestParametricDns.test_unif
    #
