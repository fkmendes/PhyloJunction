...
class MacroevolEventHandler:
    ...
    slice_t_ends: ty.List[ty.Optional[float]]
    str_representation: str
    def __init__(self, a_state_dep_rate_manager: DiscreteStateDependentParameterManager, a_state_dep_prob_manager: ty.Optional[DiscreteStateDependentParameter]=None) -> None: ...
