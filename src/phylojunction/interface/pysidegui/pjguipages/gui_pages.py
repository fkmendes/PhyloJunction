...
"")
        ...
        self.clear_model.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.clear_model.setStyleSheet("QAbstractButton {\n"
"    qproperty-icon: theme_url(\"src/phylojunction/interface/pysidegui/pjguipages/../images/icons/icon_clear.svg\") off,\n"
"        qproperty-icon: theme_url(\"src/phylojunction/interface/pysidegui/pjguipages/../images/icons/icon_clear_clicked.svg\") on;\n"
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("src/phylojunction/interface/pysidegui/pjguipages/../images/icons/icon_clear.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon.addPixmap(QtGui.QPixmap("src/phylojunction/interface/pysidegui/pjguipages/../images/icons/icon_clear_clicked.svg"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
        icon.addPixmap(QtGui.QPixmap("src/phylojunction/interface/pysidegui/pjguipages/../images/icons/icon_clear_clicked.svg"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.On)
...
"border: 0;")
        self.compare_node_frame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.compare_node_frame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
...
"}")
        ...
        self.compare_node_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.avg_replicate_check_button.setGeometry(QtCore.QRect(20, 320, 155, 20))
        ...
        self.avg_replicate_check_button.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        ...
        self.node_stat_vert_layout.addWidget(self.compare_stats_label, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"}")
        ...
        self.node_stat_vert_layout.addWidget(self.summary_stats_list, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.compare_csv_button.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
...
"}")
        ...
        self.csv_violinplot_vert_layout.addWidget(self.compare_csv_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"font: 11pt \"Courier\";")
        ...
        self.draw_violins_button.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
...
"}")
        ...
        self.save_violins_button.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
...
"}")
        ...
        self.horizontalLayout_5.addWidget(self.read_hpd_csv_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"}")
        ...
        self.horizontalLayout_5.addWidget(self.read_logfile_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"font: 11pt \"Courier\";")
        ...
        self.gridLayout_5.addWidget(self.coverage_csv_textbox, 0, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"border-radius: 2px;")
        ...
        self.gridLayout_5.addWidget(self.coverage_textbox, 0, 1, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.csv_covplot_vert_layout.addWidget(self.coverage_page_matplotlib_widget, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"}")
        ...
        self.cov_draw_save_hor_layout.addWidget(self.draw_cov_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"}")
        ...
        self.cov_draw_save_hor_layout.addWidget(self.save_cov_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"border: 0;")
        self.coverage_frame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.coverage_frame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
...
"}")
        ...
        self.coverage_node_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.coverage_node_label.setObjectName("coverage_node_label")
        self.cov_node_stat_vert_layout.addWidget(self.coverage_frame, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.cov_node_stat_vert_layout.addWidget(self.compare_stats_label_2, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
...
"}")
        ...
        self.cov_node_stat_vert_layout.addWidget(self.cov_summary_stats_list, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
