...
class Ui_PJGUIPages(object):
    def setupUi(self, PJGUIPages):
        ...
        self.settings_page_grid_layout.addItem(spacerItem, 7, 0, 1, 1)
        ...
        self.tree_dag_node_label = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.tree_dag_node_label.setObjectName("tree_dag_node_label")
        ...
        self.stoch_map_label = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.stoch_map_label.setMinimumSize(QtCore.QSize(0, 24))
        self.stoch_map_label.setMaximumSize(QtCore.QSize(16777215, 24))
        font = QtGui.QFont()
        font.setBold(True)
        self.stoch_map_label.setFont(font)
        self.stoch_map_label.setObjectName("stoch_map_label")
        ...
        self.sim_config_label = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.sim_config_label.setMinimumSize(QtCore.QSize(0, 24))
        font = QtGui.QFont()
        font.setBold(True)
        self.sim_config_label.setFont(font)
        self.sim_config_label.setObjectName("sim_config_label")
        self.settings_page_grid_layout.addWidget(self.sim_config_label, 0, 0, 1, 1)
        self.attr_name_label = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.attr_name_label.setMinimumSize(QtCore.QSize(0, 24))
        self.attr_name_label.setMaximumSize(QtCore.QSize(16777215, 24))
        self.attr_name_label.setObjectName("attr_name_label")
        self.settings_page_grid_layout.addWidget(self.attr_name_label, 6, 0, 1, 1)
        self.tr_dag_node_textbox = QtWidgets.QTextEdit(self.gridLayoutWidget_4)
        self.tr_dag_node_textbox.setMinimumSize(QtCore.QSize(0, 24))
        self.tr_dag_node_textbox.setMaximumSize(QtCore.QSize(16777215, 24))
        self.tr_dag_node_textbox.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.tr_dag_node_textbox.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.tr_dag_node_textbox.setObjectName("tr_dag_node_textbox")
        self.settings_page_grid_layout.addWidget(self.tr_dag_node_textbox, 5, 1, 1, 1)
        self.attr_name_textbox = QtWidgets.QTextEdit(self.gridLayoutWidget_4)
        self.attr_name_textbox.setMinimumSize(QtCore.QSize(0, 24))
        self.attr_name_textbox.setMaximumSize(QtCore.QSize(16777215, 24))
        self.attr_name_textbox.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.attr_name_textbox.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.attr_name_textbox.setObjectName("attr_name_textbox")
...
"")
        ...
        self.reconstructed_tree_check = QtWidgets.QCheckBox(self.gridLayoutWidget)
        self.reconstructed_tree_check.setObjectName("reconstructed_tree_check")
        self.radio_spin_hor_layout.addWidget(self.reconstructed_tree_check)
...
"color: red;")
    ...
    def retranslateUi(self, PJGUIPages):
        ...
        self.tree_dag_node_label.setText(_translate("PJGUIPages", "Tree DAG node(s)"))
        self.random_seed_prefix_label.setText(_translate("PJGUIPages", "Random seed:"))
        self.stoch_map_label.setText(_translate("PJGUIPages", "Stochastic mapping"))
        self.settings_label.setText(_translate("PJGUIPages", "Output configuration"))
        self.sim_config_label.setText(_translate("PJGUIPages", "Simulation configuration"))
        self.attr_name_label.setText(_translate("PJGUIPages", "Attribute name"))
        ...
        self.reconstructed_tree_check.setText(_translate("PJGUIPages", "Reconstructed"))
