...
def val_or_obj(dag_obj: pgm.DirectedAcyclicGraph, val: ty.List[str]) -> ty.List[ty.Union[pgm.NodePGM, str]]: ...
def parse_spec(dag_obj: pgm.DirectedAcyclicGraph, fn_spec_str: str, cmd_line: str) -> ty.Tuple[ty.Dict[str, ty.List[ty.Union[str, pgm.NodePGM]]], ty.List[pgm.NodePGM]]: ...
