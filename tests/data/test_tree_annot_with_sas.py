...
class TestAnnotateTreeWithSAs(unittest.TestCase):
    ...
    def test_node_counting_oneSA_no_spn_survives(self):
        ...
        ann_tr_sa_no_spn_built = pjtr.AnnotatedTree(
        ...
        self.assertEqual(ann_tr_sa_no_spn_built.n_extant_terminal_nodes, 1, "Count of terminal extant nodes should be 1.")
        self.assertEqual(ann_tr_sa_no_spn_built.n_extinct_terminal_nodes, 0, "Count of terminal extinct nodes should be 0.")
        self.assertEqual(ann_tr_sa_no_spn_built.n_sa, 1, "Count of sampled ancestor nodes should be 1.")
    ...
    def test_node_counting_twoSAs_no_spn_survives(self):
        ...
        self.assertEqual(ann_tr_2sas_no_spn_survives.n_sa, 2, "Count of sampled ancestor nodes should be 1.")
