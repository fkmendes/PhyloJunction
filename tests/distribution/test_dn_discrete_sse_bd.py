...
class TestBDTrees(unittest.TestCase):
    ...
    def test_tree_size_total_count_max_taxa_bd(self):
        """
        Test if birth-death trees simulated here have similar root ages and number of sampled ancestors
        as trees simulated with geiger
    ...
    def test_tree_size_total_count_max_t_bd(self):
        """
        Test if birth-death trees simulated here have similar root ages and number of total taxa
        as trees simulated with TreeSim

        Note: condition_on_speciation=False to match TreeSim!
        """
        ...
        for i, batch in enumerate(sim_batches):
            ...
            print("min n total = " + str(min(n_total)))
            print("min root age = " + str(min(root_ages)))
